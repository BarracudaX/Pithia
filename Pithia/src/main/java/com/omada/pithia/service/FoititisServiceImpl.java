...
@Transactional
public class FoititisServiceImpl implements FoititisService {
	...
	@Override
	public Foititis loadThewries(Foititis foititis) {
		Foititis foititisMeThewries = entityManager.merge(foititis);

		return foititisMeThewries;
	}
}
